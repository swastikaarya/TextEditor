...
{
	private final static String KEY_STATE="UndoableTestAreaKey";
	...
	private void initUndoable() {
		...
		addFocusListner(new FocusAdapter() {
...
public class TextEditor extends Frame{
	...
	TextEditor()
	{
		...
		MenuItem n=new MenuItem("Open",new)
		        MenuShortcut(KeyEvent.VK_O));
		MenuItem n=new MenuItem("Save",new)
			    MenuShortcut(KeyEvent.VK_S));
		MenuItem n=new MenuItem("Exit",new)
...
class New implements ActioListener
{
...
class Open implements ActionListener
{
	public void actionPerformed(ActionEvent ae)
	{
		FileDialog fd=new FileDialog(TestEditor.this,"Select");
		fd.show();
...
class Save implements ActionListener
{
	public void actionPerformed(ActionEvent ae)
	{
		FileDialog fd=new FileDialof(TextEditor.this,"SaveFile",FileDialog);
				fd.setFile(fn);
				fd.setDirectory(dn);
				fd.show();
...
{
	try {
		DataOutputStream d=new DataOutputStream (new FileOutputstreamr(filename));
		String line=txt.getText();
		BufferReader br=new BufferReader(new StringReader(line));
...
class Paste implements ActionListener
{
	public void actionPerformed(ActionEvent ae)
	{
		...
		try {
			String
			sel=(String)cliptran.getTransferData(DataFlavour.stringFlavor);
	...
	{
		public void actionPerformed(actionWEvent e)
		{
...
class Type implements ActionListener
{
	public void actionPerformed(ActionEvent e)
	{
		...
		if(lbl=="Helvetica")
		{
			f=new Font("Helvitica",style,fsize);
			txt.setFont(f);
		}
		if(lbl=="Arial")
		{
